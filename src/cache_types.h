...
void cacheShipTypes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheStaOperations_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheRamAssemblyLineTypesCategory_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvCategories_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheDogmaEffects_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheRamCompletedStatuses_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvBlueprintTypes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheRamTypeRequirements_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheCertificateRelationships_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheDogmaAttributes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheRamAssemblyLineTypes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheStaStationsStatic_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvGroups_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvMetaTypes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvTypeReactions_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheDogmaTypeEffects_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cachePlanetSchematics_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheDogmaUnits_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cachePlanetSchematicsTypeMap_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheDogmaTypeAttributes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheDogmaExpressions_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheRamAssemblyLineTypesGroup_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheResGraphics_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvTypes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheResIcons_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheActBillTypes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cachePlanetSchematicsPinMap_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvContrabandTypes_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvMetaGroups_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheCertificates_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheInvTypeMaterials_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheResSounds_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
void cacheRamActivities_draw_edit(std::list<edit_window *> *w, edit_window *e, cache_collection *cc);
